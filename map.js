...
var unhighlightedIcon = L.Icon.extend({
  options: {
    iconUrl: "library/leaflet/images/marker-icon.png",
	  iconAnchor: [12, 41],
	  iconSize: [25, 41]
  }
});
...
var highlightedIcon = L.Icon.extend({
  options: {
  	iconUrl: "library/leaflet/images/marker-icon-lightblue.png",
  	iconAnchor: [12, 41],
  	iconSize: [25, 41]
  }
});
...
var otherIcon = L.Icon.extend({
  options: {
  	iconUrl: "library/leaflet/images/marker-icon-other.png",
  	iconAnchor: [12, 41],
  	iconSize: [25, 41]
  }
});
